...
func.func @matmul_2048x512x1024_f16_f16() {
...
//  %CC = linalg.fill ins(%c0 : f16) outs(%init : tensor<3456x1024xf32>) -> tensor<3456x1024xf32>
//  %D = linalg.matmul ins(%lhs, %rhs: tensor<3456x2048xf16>, tensor<2048x1024xf16>)
//                    outs(%CC: tensor<3456x1024xf32>) -> tensor<3456x1024xf32>
//  check.expect_almost_eq_const(%D, dense<20.2812> : tensor<3456x1024xf32>) : tensor<3456x1024xf32>
//
//  return
//}
